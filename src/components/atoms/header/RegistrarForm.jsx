        ...
        <div className="bg-gray-100 grid place-items-center p-section">
          ...
          <form className="grid g-15" onSubmit={handleSubmit}>
            <div className="grid g-5">
              ...
              <input
                  className={`bg-back block w-full border ${errors.firstName ? 'border-red-500' : 'border-gray-300'} txt-tertiary paragraph rounded-lg focus:ring-red-500 focus:border-red-500 p-2`}
            ...
            <div className="grid g-5">
              ...
              <input
                  className={`bg-back block w-full border ${errors.lastName ? 'border-red-500' : 'border-gray-300'} txt-tertiary paragraph rounded-lg focus:ring-red-500 focus:border-red-500 p-2`}
            ...
            <div className="grid g-5">
              ...
              <input
                  className={`bg-back block w-full border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'} txt-tertiary paragraph rounded-lg focus:ring-red-500 focus:border-red-500 p-2`}
