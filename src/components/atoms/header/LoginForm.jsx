          ...
          <form className="grid g-15" onSubmit={handleSubmit}>
            ...
            <div className="grid g-5">
              <div className="flex justify-between items-end g-15">
                ...
                <Link to="/forgot-password" className="txt-primary underline decoration-solid legal">Olvidé mi
                  contraseña</Link>
              </div>
              <input
            ...
            <div className="flex justify-between items-center g-15">
              <Buttons text={<><i className="fa-brands fa-google txt-primary subtitle"></i> Continuar con Google</>}
                       type="button" bColor="#56494E" color="#56494E" bgColor="#fff"/>
              <Buttons
                  text={<><i className="fa-brands fa-facebook-f txt-primary subtitle"></i> Continuar con Facebook</>}
                  type="button" bColor="#56494E" color="#56494E" bgColor="#fff"/>
            </div>
          </form>
          {errors.general &&
