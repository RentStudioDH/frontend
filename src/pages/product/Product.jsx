...
const Product = () => {
  ...
  return (
    <main>
      {product && (
        <>
          <SectionProducto data={product} Component={ProductHeader} sectionClass="bg-back productHeader" containerClass="flex flex-row justify-between items-start sm:items-center p-15 g-15" />
          ...
          <SectionProducto data={product} Component={ProductAvailability} sectionClass="productAvailability" containerClass="p-section" />
          ...
          <SectionProducto data={product} Component={ProductPolicies} containerClass="p-section" />
        </>
      )}
